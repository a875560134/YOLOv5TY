    ...
    def __init__(self):
        ...
        try:
            ...
            T = [
                ...
                # A.OpticalDistortion(p=0.0),
                # A.GridDistortion(p=0.0),
                # A.ElasticTransform(p=0.0),
                # A.PiecewiseAffine(p=0.0),
                # A.ShiftScaleRotate(p=0.0),
                A.RGBShift(p=0.01),
                # A.CoarseDropout(p=0.01,num_holes=15,max_h_size=16,max_w_size=16),
                # A.RandomFog(p=0.01,fog_coef_upper=0.3,fog_coef_lower=0.1)
            ]
